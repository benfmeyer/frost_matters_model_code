...
private:
	...
	xtring file_mnee,file_mwcont_upper,file_mwcont_lower, file_resp;
	xtring file_firert,file_speciesheights, file_cmass_leaf, file_cmass_heart, file_cmass_root, file_cmass_sap, file_frost, file_leaf_litter, file_cmass_debt, file_lo_day;
	...
	Table out_cmass_leaf, out_cmass_heart, out_cmass_root, out_cmass_sap, out_frost, out_leaf_litter, out_cmass_debt, out_lo_day, out_resp;
