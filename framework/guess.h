...
/// BEN M.: identifier for not set variables
const int NOT_SET_INT = -9999;
const double NOT_SET_DOUBLE = -9999.0;
...
public:
	...
	/// BEN minimum air temperature today (deg C)
	double tmin;
...
public:
	...
	double intc;
	/// late-frost tolerance
	double frost_tolerance;
    /// standard deviation of late-frost tolerance
    double frost_sd;
...
public:
	...
	//BEN_FROST:
	int sec_can;
	bool was_frost = false;
    double frost_litter = 0.0;
    int a_lo_stat = NOT_SET_INT;
    int lo_day = NOT_SET_INT;
...
public:
    ...
    //BEN FROST: variables for frost adapted phenology
    int sec_can = NOT_SET_INT;
    bool was_frost = false;
    double Rc = NOT_SET_DOUBLE; // Rate of chilling from Kramer et al 2017 Eq. 3
    double Rf = NOT_SET_DOUBLE; // Rate of forcing from Kramer et al 2017 Eq. 4
    double Sc = NOT_SET_DOUBLE; // State of chilling from Kramer et al 2017 Eq. 1
    double Sf = NOT_SET_DOUBLE; // State of forcing from Kramer et al 2017 Eq. 2
    int lo_stat = NOT_SET_INT; // Leaf out status from Kramer et al 2017 Sf > Sf_thresh
    int a_lo_stat = NOT_SET_INT; // days since leaf out
